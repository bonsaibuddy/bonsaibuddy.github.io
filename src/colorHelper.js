...
const GruvboxMainText = "#8ec07c";
const GruvboxBackground = "#282828"
const GruvboxHeaderText = "#bdae93"
const GruvboxNormal = "#928374"
const tokyoNightYellow = "#ebdbb2"

// Define color arrays for each image
const colors = [
  { color: tokyoNightYellow, background: GruvboxBackground, hlcol: GruvboxHeaderText, linkcol: "#A8B8CF", hovercol: GruvboxMainText }, // colors for image 1
  { color: "#83a598", background: "#15191d", hlcol: "#83a598", linkcol: "#fabd2f", hovercol: "#d79921" }, // colors for image 2
  { color: GruvboxMainText
  , background: GruvboxBackground, hlcol: GruvboxHeaderText, linkcol: GruvboxNormal, hovercol: tokyoNightYellow },  // colors for image 3
];
